...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/%E6%95%B0%E6%8D%AE%E6%9B%B4%E6%96%B0-2026--09--03%2016.28%20UTC-informational" alt="数据更新">
</p>
...
| **KKtoken AI** | 🔴 异常 | **$120** | 注册 $75 + 本页邀请 $25 + 首签 $20 | $20/天 | Anthropic + OpenAI | 需登录查看 | [GitHub 注册 →](https://kktoken.cc/sign-up?aff=MzG9) |
...
| **TaBiAI** | 🟢 在线 | **$120** | 注册 $100 + 本页邀请 $20 | 支持签到 | Anthropic + OpenAI | 2 个可查 | [GitHub 注册 →](https://tabitoken.com/sign-up?aff=EQIT) |
...
> 「首日可得」= 注册基础额度 + 本页邀请链接额度 + 当天能领的签到额度（每日重置额度池的站点按一天的池子算）；模型、价格、在线状态由脚本抓取站点公开接口自动生成，最后更新：`2026-09-03 16:28 UTC`。
>
> 8 个按美元计价、且还收新用户的站全注册一遍，第一天手上大约有 **$817** 额度可用（其中每日重置的额度池次日会回满，但不累积）；Matrix 另发 600 积分，NOFX 另发 15 积分，是站内积分、与美元没有公开换算，未计入这个合计。
>
...
- ⚠ 接口已连续 50 小时没抓到新数据，下列信息为 `2026-09-01 14:01 UTC` 的快照
- 站点名称：**Agent Router**
...
- 在线看：[变动日志](https://panxunying.github.io/ai-coding-welfare/changelog/) · [可用性历史](https://panxunying.github.io/ai-coding-welfare/status/)

最近几条：

- `2026-09-03` 🔴 KKtoken AI 探测不到了：注册页与公开接口都没响应
- `2026-09-03` 🔴 RawChat 公益站 探测不到了：注册页与公开接口都没响应
- `2026-09-01` ➖ TaBiAI 下线模型：claude-opus-4-8、claude-opus-4-8-thinking
- `2026-09-01` 🆕 新收录 CheapCodex：邀请再加 $20，每日签到 $20
- `2026-09-01` 🆕 新收录 NOFX：邀请再加 10 积分，每日签到 $5
- `2026-09-01` 🆕 新收录 AnyRouter：注册送 $75，邀请再加 $50，每日签到 $25
